...
- ✅ **[L4]** SLO-optimal P/D scheduling as an open problem (joint TTFT/TPOT objective over prefill chunks and decode steps) — `lessons/frontier-ops.md`, `questions/frontier-ops.yaml`.
- ✅ **[L4]** Cross-phase interference on shared hardware as active research (modeling/predicting the stall vs. sidestepping it by disaggregation) — `lessons/frontier-ops.md`, `questions/frontier-ops.yaml`.
...
- ✅ **[L3]** Operational signals (TTFT & TPOT/ITL percentiles, per-phase queue depth, batch composition, per-phase SLO-attainment) — drilled in `lessons/frontier-ops.md`, `questions/frontier-ops.yaml`.
