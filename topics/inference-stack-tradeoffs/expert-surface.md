...
- ⬜ **[L4]** Joint multi-objective optimization as an open problem (levers interact, SLOs unpredictable under load) — named in `lessons/expert-context.md`; no dedicated frontier drill.
...
- 🟡 **[L3]** Combined eval + cost + observability stacks to optimize all four axes together — named in `lessons/expert-context.md`; not drilled as operational metrics.
...
## Coverage summary
19 items · ✅ 16 covered · 🟡 2 partial · ⬜ 1 gap. Weighted coverage (covered=1, partial=0.5) ≈ **89%**.
Open frontier work: a joint multi-objective-optimization frontier drill, a FrugalGPT cascade coding
exercise, and an eval+cost+observability operational metrics drill.

<!-- coverage: items=19 covered=16 partial=2 gap=1 -->
